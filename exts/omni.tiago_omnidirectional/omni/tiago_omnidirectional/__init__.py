...
class OmniTiago_omnidirectionalExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.tiago_omnidirectional] OmniTiago_omnidirectionalExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.tiago_omnidirectional] OmniTiago_omnidirectionalExtension shutdown", flush=True)
